...
export default function EditFeeInterval({ data, onClose }) {
  const [isLoading, setIsLoading] = useState(false);
  const [feeInterval, setFeeInterval] = useState(data);
  ...
  return (
    <Modal onClose={onClose} title={"Edit Fee Interval Details"}>
      <form
