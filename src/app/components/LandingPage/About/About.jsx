  ...
  return (
    <section className="py-20" id="about">
      <div className="container mx-auto max-w-7xl">
        <h2 className="text-4xl font-bold text-center mb-12 text-primary">About Our System</h2>
        <div className="">
          <p className="text-lg mb-6 text-ternary">
          ...
          <ul className="grid md:grid-cols-2 gap-4 mb-6">
            {[
              ...
              <li key={index} className="flex items-start space-x-2">
                <CheckCircle className="w-5 h-5 text-[#4ECDC4] flex-shrink-0 mt-1" />
                <span className="text-ternary">{item}</span>
              </li>
            ))}
          </ul>
